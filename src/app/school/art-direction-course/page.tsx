        ...
        <section className="xl:pb-32 md:pb-24 pb-16">
          <div className="flex flex-col xl:gap-16 gap-8">
              ...
              <CarouselContent className="lx:mx-40 mx-8">
                {feedbacks.map(
                  (feedback: {
                    ...
                    <CarouselItem
                      key={feedback.name}
                      className="lg:basis-[768px] basis-full pl-10"
                    >
                      <figure className="flex items-start gap-6 py-8 px-6 bg-gray">
                        ...
                        <div className="flex flex-col gap-4">
                          ...
                          <span className="lg:h5 h6 text-white">
                            {feedback.name}
                          </span>
                        </div>
                      </figure>
            ...
            <p className="max-w-screen-md self-center text-center p-base text-pretty">
              ...
              Effects та Illustrator (або інші альтернативні програми для
              створення графіки, в яких вам зручно працювати). Ви будете
              самостійно створювати ілюстрації та анімацію, тож треба мати
              відповідні навички. Якщо ви не впевнені, чи достатньо ваших скілів
              для участі в курсі – напишіть мені!
            </p>
          </div>
        </section>
      </WhiteWrapperLayout>
