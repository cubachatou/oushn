  ...
  return (
    <>
      ...
      <WhiteWrapperLayout>
        <IntroTextSection
          title="Accents in Motion characters workshop"
          description="Цей воркшоп присвячений темі Акцентної персонажної анімації в моушн дизайні. Поглиблюємо наші знання, покращуємо навички та навчаємось планувати персонажну анімацію з урахуванням ритму та динаміки. Переводимо нашу персонажку на новий рівень - від посередньої монотонності до акцентної виразності."
          ...
          <div className="container max-w-screen-sm">
            ...
            <div className="sm:my-16 my-8 flex flex-col ms:gap-8 gap-4">
              ...
              <p className="p-base text-center text-pretty">
                3 уроки в записі - дивись в зручний для тебе час. Підготовлені
                під анімацію файли для роботи на воркшопі та виконання домашніх
                завдань. Чатик для комунікації з іншими студентами воркшопу та
                отримання фідбеку на домашки.
              </p>
            </div>
            ...
            <ul className="sm:my-16 my-8 list-disc list-inside marker:text-middle-pink p-medium [&_li:not(:last-child)]:mb-[0.75em] [&_span]:-ml-[0.5em] [&_span]:text-middle-pink">
              ...
              <li>
                <span>Практика 2.</span> Ігрова сцена з фокусом на перформансі
                персонажа
              </li>
              <li>
              ...
              <li>
                <span>Чатик</span> для спілкування та отримання фідбеку (один
                фідбек на кожну домашку)
              </li>
            </ul>
            ...
            <div className="sm:mt-20 mt-12 sm:mb-24 mb-16 flex flex-col sm:gap-8 gap-4">
              ...
              <p className="p-base text-center text-pretty">
                Для моушн дизайнерів та аніматорів, які вже вміють анімувати
                персонажів в After Effects, але прагнуть поглибити свої знання
                та покращити навички. Зауважте - воркшоп рівня middle - ми не
                будемо вивчати основи персонажної анімації та ріггінгу.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div className="flex flex-col items-center gap-10 text-center">
              ...
              <strong className="inline-block p-base font-GillLight">
                *Для студентів Режисерського курсу діє знижка, напишіть мені!
              </strong>
            </div>
          </div>
        </section>
